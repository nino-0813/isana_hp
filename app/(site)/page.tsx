    ...
    <div className="pb-32">
      ...
      <section className="py-24 md:py-32 px-6 bg-white">
        <div className="max-w-2xl mx-auto text-center">
          <p className="text-ink/80 text-lg md:text-xl leading-relaxed mb-8">
          ...
          <Link
            href="/services"
            className="mt-12 inline-flex items-center justify-center w-full max-w-[320px] mx-auto h-14 rounded-full bg-ink text-white hover:bg-gold transition-all duration-500 font-medium text-sm tracking-wide"
      ...
      <section className="py-24 md:py-32 px-6 bg-ivory">
        <div className="max-w-5xl mx-auto">
          <div className="relative w-full aspect-[4/3] md:aspect-[3/2] max-h-[50vh] rounded-2xl overflow-hidden mb-20 luxury-border shadow-xl">
            <img
              src="/images/h_01.svg"
              alt="数秘術と世界の伝統"
              className="absolute inset-0 w-full h-full object-cover object-center"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-16">
            <motion.div
              ...
              viewport={{ once: true }}
              className="p-8 border border-gold/10 rounded-2xl bg-white/70"
            >
              <h3 className="text-xl font-serif text-ink mb-6 pb-4 border-b border-gold/20">数秘の起源と歴史</h3>
            ...
            <motion.div
              ...
              className="p-8 border border-gold/10 rounded-2xl bg-white/70"
            >
              <h3 className="text-xl font-serif text-ink mb-6 pb-4 border-b border-gold/20">世界各地の数秘の伝統と文化</h3>
              <p className="text-ink/70 leading-relaxed mb-4">
      ...
      <section className="py-24 md:py-32 px-6 bg-ivory">
        <div className="max-w-5xl mx-auto mb-16">
          <motion.div
            ...
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            className="relative w-full aspect-[4/3] md:aspect-[3/2] max-h-[50vh] rounded-2xl overflow-hidden luxury-border shadow-xl"
          >
            <img
        ...
        <div className="max-w-4xl mx-auto mb-16 text-center">
          <span className="text-gold tracking-[0.3em] uppercase text-xs font-semibold mb-4 block">Core</span>
          <h2 className="text-3xl md:text-4xl font-serif mb-4">数秘術の核心</h2>
        ...
        <div className="max-w-4xl mx-auto space-y-8">
          {CORE_ITEMS.map((item, i) => (
            <motion.div
              ...
              className="p-8 md:p-10 border border-gold/10 rounded-2xl bg-white/60 hover:border-gold/25 transition-colors"
            >
              <div className="flex flex-col sm:flex-row gap-6 sm:gap-8">
                <span className="flex-shrink-0 w-12 h-12 rounded-full bg-champagne flex items-center justify-center text-gold font-serif text-xl font-bold">
                  {i + 1}
                </span>
                <div>
      ...
      <section className="py-24 md:py-32 px-6 bg-white">
        ...
        <div className="max-w-4xl mx-auto text-center mb-14">
          <span className="text-gold tracking-[0.3em] uppercase text-xs font-semibold mb-4 block">Biorhythm</span>
          <h2 className="text-3xl md:text-4xl font-serif mb-4">バイオリズムの9つの波</h2>
        ...
        <div className="max-w-4xl mx-auto grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-4">
          {NINE_WAVES.map(({ num, label }, i) => (
            <motion.div
              ...
              className="p-6 rounded-2xl border border-gold/10 bg-ivory/50 text-center hover:border-gold/20 transition-colors"
            >
              <span className="block text-2xl font-serif font-bold text-gold mb-1">{num}</span>
              <span className="text-ink font-medium text-sm">{label}</span>
            </motion.div>
          ))}
        </div>
        <p className="text-ink/50 text-sm text-center mt-10 max-w-lg mx-auto">
      ...
      <section className="py-24 md:py-32 px-6 bg-ivory">
        ...
        <div className="max-w-4xl mx-auto mb-14 text-center">
          <span className="text-gold tracking-[0.3em] uppercase text-xs font-semibold mb-4 block">Basics</span>
          <h2 className="text-3xl md:text-4xl font-serif mb-4">数秘の基礎</h2>
          <div className="w-20 h-px bg-gold mx-auto" />
        </div>
        <div className="max-w-4xl mx-auto space-y-8">
          {[
      ...
      <section className="py-24 md:py-32 px-6 bg-white">
        <div className="max-w-3xl mx-auto mb-16">
          <motion.div
            ...
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            className="relative w-full aspect-[4/3] md:aspect-[3/2] max-h-[36vh] rounded-2xl overflow-hidden luxury-border shadow-xl"
          >
            <img
        ...
        <div className="max-w-4xl mx-auto space-y-8">
          {[
            ...
            <motion.div
              ...
              className="p-8 md:p-10 border border-gold/10 rounded-2xl bg-ivory/50 hover:border-gold/25 transition-colors"
            >
              <p className="text-ink/80 leading-relaxed mb-6">&ldquo;{item.voice}&rdquo;</p>
              <span className="text-ink/50 text-sm">{item.label}</span>
            </motion.div>
          ))}
        </div>
      </section>
      ...
      <section className="py-24 md:py-32 px-6 bg-ivory">
        <div className="max-w-4xl mx-auto flex flex-col md:flex-row items-center justify-center gap-16">
          ...
          >
            <span className="font-serif text-4xl md:text-5xl text-gold tracking-tight">131</span>
            <span className="text-ink/50 text-xs tracking-[0.3em] mt-2">isana</span>
          </motion.div>
          <motion.div
            initial={{ opacity: 1, x: 0 }}
            whileInView={{ opacity: 1, x: 0 }}
            ...
            className="max-w-md"
          >
            <span className="text-gold tracking-[0.2em] uppercase text-xs font-semibold mb-4 block">Profile</span>
      ...
      {/* 6. CTA（Contact 前の締め） */}
      <section className="relative py-28 md:py-36 px-6 overflow-hidden bg-gradient-to-b from-champagne/80 via-ivory to-champagne/90">
        ...
        <div className="relative z-10 max-w-3xl mx-auto text-center">
          <Compass size={40} className="text-gold mx-auto mb-8" />
          <h2 className="text-3xl md:text-4xl font-serif mb-6 text-ink leading-tight">
            あなたの運命を、
            <br />
            数字から紐解きませんか？
          </h2>
          <p className="text-ink/60 text-base md:text-lg mb-10">
